...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/html2canvas/dist/html2canvas.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{}],"src/unsplash.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  var unsplashURL = "https://api.unsplash.com//photos/random?client_id=0wxTqQs17WXI889gICWpJe_417SUkIwlYoVq2eQqX5U&query=cats&orientation=landscape";
  var catPicsArray = ["../imgs/cat-1.jpeg", "../imgs/cat-2.jpeg", "../imgs/cat-3.jpeg", "../imgs/cat-4.jpeg", "../imgs/cat-5.jpeg", "../imgs/cat-6.jpeg", "../imgs/cat-7.jpeg", "../imgs/cat-8.jpeg", "../imgs/cat-9.jpeg", "../imgs/cat-10.jpeg", "../imgs/cat-11.jpeg", "../imgs/cat-12.jpeg", "../imgs/cat-13.jpeg", "../imgs/cat-14.jpeg", "../imgs/cat-15.jpeg"];
  console.log(catPicsArray.length);
  var displayLocalCat = function displayLocalCat(array) {
    var randomIndex = Math.floor(Math.random() * catPicsArray.length);
    var item = array[randomIndex];
    return item;
  };
  var catPic = document.querySelector(".poster__cat");
  var catImg = document.createElement("img");
  catPic.appendChild(catImg);
  console.log(catPic);
  var displayCat = function displayCat() {
    _axios.default.get(unsplashURL).then(function (response) {
      var catURL = response.data.urls.regular;
      var borderColor = response.data.color;
      console.log("cat url: ".concat(catURL));
      console.log("cat color: ".concat(borderColor));
      ...
      console.log(error);
      var catfile = displayLocalCat(catPicsArray);
  ...
  var quoteMainText = document.querySelector(".poster__text--maintext");
  var quoteAuthor = document.querySelector(".poster__text--attribution");
  var quoteButton = document.querySelector(".main__btn");
  var loadQuote = function loadQuote() {
    _axios.default.get(quoteURL).then(function (response) {
      //call an array of the data
      var motivationQuotes = response.data;
      ...
      var result = getRandomItem(motivationQuotes);
   ...
   */
  var headlineArray = ["Action", "Accomplishment", "Courage", "Bravery", "Adventure", "Appreciation", "Ambition", "Perserverance", "Patience", "Possibilities", "Power", "Practice"];

  /**
   * generate the headline
   */
  var headline = document.querySelector(".poster__text--headline");
  var generateHeadline = function generateHeadline(array) {
    var random = Math.floor(Math.random() * array.length);
    var headlineString = array[random].split("").join(" • ");
...
var shareBtn = document.querySelector(".main__copy");
var topTen = document.querySelector(".topTenPoster");
shareBtn.addEventListener("click", function () {
  (0, _html2canvas.default)(document.querySelector(".poster__wrapper"), {
    letterRendering: 1,
    allowTaint: true
  }).then(function (canvas) {
    var posterList = document.createElement("ul");
    posterList.classList.add("topten__list");
    var posterListItem = document.createElement("li");
...
},{"../styles/styles.scss":"styles/styles.scss","axios":"node_modules/axios/index.js","html2canvas":"node_modules/html2canvas/dist/html2canvas.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "39125" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/unsplash.js"], null)
//# sourceMappingURL=/unsplash.b2cbceaa.js.map